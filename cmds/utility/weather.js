...
const exampleEmbed = (
    ...
    new Discord.MessageEmbed()
        .setColor('#484848')
        .setTitle(`It is ${Math.round(temp * 9 / 5 + 32)}\u00B0 F in ${cityName}, ${country}`)
        .addField(`Maximum Temperature:`, `${Math.round(maxTemp * 9 / 5 + 32)}\u00B0 F`, true)
        .addField(`Minimum Temperature:`, `${Math.round(minTemp * 9 / 5 + 32)} \u00B0 F`, true)
