...
client.on('message', async (message) => {
	...
	if (message.mentions.has(client.user.id) && !message.content.includes(`@everyone`) || !message.content.includes("@here")) message.channel.send(`Well... this is awkward... your server's prefix is \`${prefix}\`...`)
