...
Canvas.registerFont(`${process.cwd()}/assets/fonts/BebasNeue-Regular.ttf`, "BebasNeueRegular")
const { MessageAttachment } = require("discord.js")
const background = 'https://cdn.discordapp.com/attachments/757768055479861278/758090856325709885/bh.jpeg'
...
module.exports = {
    ...
    callback: (client, message, args) => {
        ...
        let WELCOME_MESSAGE_TEXT = `You are our ${message.guild.members.cache.size}th member!`;
            ...
            const SECOND_MESSAGE = `Welcome to this Server!`; // this is gonna be the message above the canvas, same thing you don't have to include this.
